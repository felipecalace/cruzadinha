...
var questions_list = [
    ...
    'Tipo particular de EPROM que mantém as informações armazenadas sem a necessidade de uma fonte de energia elétrica',
...
function verify() {
    ...
    if (answer != '') {
        ...
        if (answer == special_words[cont_correctAnswer].toLowerCase()) {
